...
Top 100 Currently Trending Artists 

[http://api.veveo.net/music/data/trends?custid=rovi&with\_gid=1&filter\_by\_gid\_type=person&num=-1](http://api.veveo.net/music/data/trends?custid=rovi&with_gid=1&filter_by_gid_type=person&num=-1)

Top 100 Currently Trending Tracks

[http://api.veveo.net/music/data/trends?custid=rovi&with\_gid=1&filter\_by\_gid\_type=track&num=-1](http://api.veveo.net/music/data/trends?custid=rovi&with_gid=1&filter_by_gid_type=track&num=-1) 
...
Our all-time artist popularity is based on a scale of 0-800, here's an example for 'Alicia Keys' - 

[http://api.veveo.net/music/data/popularity/base?custid=rovi&Nameid=MN0000005307](http://api.veveo.net/music/data/popularity/base?custid=rovi&Nameid=MN0000005307) 

Our all-time track popularity is based on a scale from 0-350, here's an example for her track, 'Fallin' -

[http://api.veveo.net/music/data/popularity/base?custid=rovi&Trackid=MT0047486812](http://api.veveo.net/music/data/popularity/base?custid=rovi&Trackid=MT0047486812) 
